...
#
    ...
    for (r in contestedVotes){
        ...
        votStart<-grep("[Aa]bstención [0-9]{1,2}.*",thisRC)+1
...
#        tmp<-grep("recoger la",votes); drop<-append(drop,tmp)
        ...
        for (d in 1:Ndip){
            ...
            vo<-sub(votes[d],
                     pattern=".* ([[:alpha:]]*)[.]{0,1}$",
                     replacement="\\1")
            vo <- ifelse(vo=="Abstención",3,ifelse(vo=="Sí",1,ifelse(vo=="No",2,vo)))
            sessLists[d,1,r]<-nom
            sessLists[d,2,r]<-vo
...
#            sessLists[d,6,r]<-nom4
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ALVARADO VILLAZ[ÓO]N ANA\\>.*", sessLists[d,1,r])=="TRUE", "rp19p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ALVARADO VILLAZ[ÓO]N FRANCISCO\\>.*", sessLists[d,1,r])=="TRUE", "rp19s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<[ÁA]LVAREZ ESCUDERO JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "rp04s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<[ÁA]LVAREZ ROMO LEONARDO\\>.*", sessLists[d,1,r])=="TRUE", "rp17p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ANAYA GONZ[ÁA]LEZ ORLANDO\\>.*", sessLists[d,1,r])=="TRUE", "rp01s", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ARRONTE OLGU[ÍI]N MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "mr20s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ARZATE FLORES JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "rp15s", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<[ÁA]VILA ROJAS SERGIO\\>.*", sessLists[d,1,r])=="TRUE", "mr34p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<BELTR[ÁA]N CORDERO JUAN\\>.*", sessLists[d,1,r])=="TRUE", "mr28p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<BONILLA CEDILLO JACOBO\\>.*", sessLists[d,1,r])=="TRUE", "rp13p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<BRAVO L[ÓO]PEZ HIP[ÓO]LITO\\>.*", sessLists[d,1,r])=="TRUE", "mr37p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<BUSTOS PASCUAL JUAN\\>.*", sessLists[d,1,r])=="TRUE", "mr06p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<CAÑIZO CUEVAS GLORIA\\>.*", sessLists[d,1,r])=="TRUE", "rp21p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<C[ÁA]RDENAS S[ÁA]NCHEZ NANCY\\>.*", sessLists[d,1,r])=="TRUE", "mr36p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<CASTILLA MARROQU[ÍI]N AGUST[ÍI]N\\>.*", sessLists[d,1,r])=="TRUE", "rp07p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<CEDILLO FERN[ÁA]NDEZ SERGIO\\>.*", sessLists[d,1,r])=="TRUE", "mr24p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<CER[ÓO]N MART[ÍI]NEZ M[ÁA]XIMO\\>.*", sessLists[d,1,r])=="TRUE", "mr05s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<C[ÍI]RIGO V[ÁA]ZQUEZ V[ÍI]CTOR\\>.*", sessLists[d,1,r])=="TRUE", "mr22p", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<DAMI[ÁA]N PERALTA ESTHELA\\>.*", sessLists[d,1,r])=="TRUE", "mr11p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<D[ÍI]AZ CUERVO JORGE\\>.*", sessLists[d,1,r])=="TRUE", "rp25p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ERRASTI ARANGO MIGUEL\\>.*", sessLists[d,1,r])=="TRUE", "rp05p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ESPINO AR[ÉE]VALO FERNANDO\\>.*", sessLists[d,1,r])=="TRUE", "rp22p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ESQUIVEL CARRILLO JES[ÚU]S\\>.*", sessLists[d,1,r])=="TRUE", "mr40s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GARC[ÍI]A HERN[ÁA]NDEZ JUAN\\>.*", sessLists[d,1,r])=="TRUE", "mr18p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GARC[ÍI]A AYALA MARCO\\>.*", sessLists[d,1,r])=="TRUE", "rp18p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GARC[ÍI]A VILLARREAL MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "rp22s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GARFIAS MALDONADO MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "mr19p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GAZC[ÓO]N L[ÓO]PEZ CANO SILVIA\\>.*", sessLists[d,1,r])=="TRUE", "rp18s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<G[ÓO]MEZ VALENZUELA MIRIAM\\>.*", sessLists[d,1,r])=="TRUE", "mr34s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<G[ÓO]MEZ G[ÓO]MEZ CARLOS\\>.*", sessLists[d,1,r])=="TRUE", "rp26s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GONZ[ÁA]LEZ DEL ANGEL RICARDO\\>.*", sessLists[d,1,r])=="TRUE", "mr13s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GONZ[ÁA]LEZ CASE ARMANDO\\>.*", sessLists[d,1,r])=="TRUE", "rp20p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<GUERRERO CASTILLO AGUST[ÍI]N\\>.*", sessLists[d,1,r])=="TRUE", "mr13p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ CASTILLA MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "mr12s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ ABARCA SAMUEL\\>.*", sessLists[d,1,r])=="TRUE", "mr29p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ HERN[ÁA]NDEZ MIGUEL\\>.*", sessLists[d,1,r])=="TRUE", "mr30s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ LEAL JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "mr32s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ  ANGELINA\\>.*", sessLists[d,1,r])=="TRUE", "mr35s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ VALENT[ÍI]N JUAN\\>.*", sessLists[d,1,r])=="TRUE", "mr36s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ MIR[ÓO]N CARLOS\\>.*", sessLists[d,1,r])=="TRUE", "mr40p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ LABASTIDA RAM[ÓO]N\\>.*", sessLists[d,1,r])=="TRUE", "rp04p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERN[ÁA]NDEZ SALGADO OSCAR\\>.*", sessLists[d,1,r])=="TRUE", "rp23s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<HERRERA ESPINOSA RA[ÚU]L\\>.*", sessLists[d,1,r])=="TRUE", "rp02s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<JIM[ÉE]NEZ L[ÓO]PEZ RAM[ÓO]N\\>.*", sessLists[d,1,r])=="TRUE", "mr01p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<JIM[ÉE]NEZ BURGOS JAIME\\>.*", sessLists[d,1,r])=="TRUE", "mr24s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<JIM[ÉE]NEZ BARR[I]{0,1}OS SERGIO\\>.*", sessLists[d,1,r])=="TRUE", "rp16s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<KURI LORENZO MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "rp21s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<LIMA BARRIOS ANTONIO\\>.*", sessLists[d,1,r])=="TRUE", "mr02p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<L[ÓO]PEZ RABAD[ÁA]N KENIA\\>.*", sessLists[d,1,r])=="TRUE", "rp01p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MACARENO MEJ[ÍI]A LEONARDO\\>.*", sessLists[d,1,r])=="TRUE", "rp24s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MART[ÍI]NEZ SOLANO JAVIER\\>.*", sessLists[d,1,r])=="TRUE", "mr07s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MART[ÍI]NEZ FISHER MARGARITA\\>.*", sessLists[d,1,r])=="TRUE", "mr14p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MART[ÍI]NEZ ARTURO RES[ÉE]NDIZ\\>.*", sessLists[d,1,r])=="TRUE", "mr16s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MART[ÍI]NEZ CAPACETA EMMA\\>.*", sessLists[d,1,r])=="TRUE", "mr27s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MART[ÍI]NEZ DELLA ROCCA SALVADOR\\>.*", sessLists[d,1,r])=="TRUE", "mr38p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MECHG[ÚU]N GONZ[ÁA]LEZ JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "mr37s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<M[ÉE]NDEZ GALV[ÁA]N MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "mr28s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<M[ÉE]NDEZ RANGEL AVELINO\\>.*", sessLists[d,1,r])=="TRUE", "mr39p", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MORGAN COL[ÓO]N HUMBERTO\\>.*", sessLists[d,1,r])=="TRUE", "mr25p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MOR[ÚU]A JASSO JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "mr32p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<MUÑOZ SANTINI INTI\\>.*", sessLists[d,1,r])=="TRUE", "mr38s", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<NORBERTO S[ÁA]NCHEZ NAZARIO\\>.*", sessLists[d,1,r])=="TRUE", "mr07p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<N[ÚU]ÑEZ L[ÓO]PEZ LORENA\\>.*", sessLists[d,1,r])=="TRUE", "rp13s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<OLAVARRIETA MALDONADO MART[ÍI]N\\>.*", sessLists[d,1,r])=="TRUE", "rp16p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ORD[ÓO]ÑEZ HERN[ÁA]NDEZ DANIEL\\>.*", sessLists[d,1,r])=="TRUE", "mr15p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<OROZCO CARMONA JUAN\\>.*", sessLists[d,1,r])=="TRUE", "mr15s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ORTEGA GONZ[ÁA]LEZ ANDREA\\>.*", sessLists[d,1,r])=="TRUE", "mr21s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ORTIZ PIÑA EDY\\>.*", sessLists[d,1,r])=="TRUE", "mr35p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<PARADA ORTEGA REBECA\\>.*", sessLists[d,1,r])=="TRUE", "rp24p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<PATRICIO RAZO MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "mr26s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<PEÑA GARAVITO JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "rp17s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<PERALTA VAQUEIRO MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "rp15p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<P[ÉE]REZ CORREA ENRIQUE\\>.*", sessLists[d,1,r])=="TRUE", "rp26p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<PIÑA OLMEDO LAURA\\>.*", sessLists[d,1,r])=="TRUE", "mr12p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<PLIEGO CALVO TOM[ÁA]S\\>.*", sessLists[d,1,r])=="TRUE", "mr10p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<QUEZADA CONTRERAS LETICIA\\>.*", sessLists[d,1,r])=="TRUE", "mr33p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<QUIÑ[ÓO]NE[ZS] CORNEJO MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "rp09p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<RAM[ÍI]REZ PINO JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "mr09p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<RAM[ÍI]REZ RODR[ÍI]GUEZ RA[ÚU]L\\>.*", sessLists[d,1,r])=="TRUE", "mr21p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<RAM[ÍI]REZ DEL VALLE DANIEL\\>.*", sessLists[d,1,r])=="TRUE", "rp11p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<REBOLLO AGUILAR CAROLINA\\>.*", sessLists[d,1,r])=="TRUE", "mr17s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<R[ÉE]TIZ GUTI[ÉE]RREZ EZEQUIEL\\>.*", sessLists[d,1,r])=="TRUE", "mr27p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<REYES AGUIRRE MARGARITO\\>.*", sessLists[d,1,r])=="TRUE", "mr29s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ANTONIO LE[ÓO]N RICARDO\\>.*", sessLists[d,1,r])=="TRUE", "mr16p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<RIVERA HERN[ÁA]NDEZ MARA\\>.*", sessLists[d,1,r])=="TRUE", "rp07s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ROCHA CRUZ LUIS\\>.*", sessLists[d,1,r])=="TRUE", "mr25s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ROMERO L[ÓO]PEZ OSCAR\\>.*", sessLists[d,1,r])=="TRUE", "mr03s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ROMERO MALDONADO AAR[ÓO]N\\>.*", sessLists[d,1,r])=="TRUE", "mr04s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ROMERO HERRERA JORGE\\>.*", sessLists[d,1,r])=="TRUE", "rp10p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ROSALES ROMERO MART[ÍI]N\\>.*", sessLists[d,1,r])=="TRUE", "mr39s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<RUBIO ALDAR[ÁA]N ELEAZAR\\>.*", sessLists[d,1,r])=="TRUE", "mr01s", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<SALAZAR N[ÚU]ÑEZ DANIEL\\>.*", sessLists[d,1,r])=="TRUE", "mr23p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<S[ÁA]NCHEZ CABRERA MARICELA\\>.*", sessLists[d,1,r])=="TRUE", "mr11s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<SANCHEZARMAS GARC[ÍI]A CARLA\\>.*", sessLists[d,1,r])=="TRUE", "rp25s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<SANTANA ALFARO ARTURO\\>.*", sessLists[d,1,r])=="TRUE", "mr26p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<SANTIB[ÁA]ÑEZ CALZADILLA FRANCISCO\\>.*", sessLists[d,1,r])=="TRUE", "rp06s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<SCHIAFFINO ISUNZA JORGE\\>.*", sessLists[d,1,r])=="TRUE", "rp14p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<SEGURA RANGEL MAR[ÍI]A\\>.*", sessLists[d,1,r])=="TRUE", "rp02p", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<T[ÉE]LLEZ S[ÁA]NCHEZ ALICIA\\>.*", sessLists[d,1,r])=="TRUE", "rp14s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<TENORIO ANTIGA XIUH\\>.*", sessLists[d,1,r])=="TRUE", "rp23p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<TOLEDO GUTI[ÉE]RREZ MAURICIO\\>.*", sessLists[d,1,r])=="TRUE", "mr30p", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<TRILLO DOM[ÍI]NGUEZ JUAN\\>.*", sessLists[d,1,r])=="TRUE", "mr31s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<TRUJILLO V[ÁA]ZQUEZ ABRIL\\>.*", sessLists[d,1,r])=="TRUE", "mr23s", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<VARGAS CORT[ÉE]Z BALFRE\\>.*", sessLists[d,1,r])=="TRUE", "mr05p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<VERDERI MUÑ[ÚU]ZURI FERNANDA\\>.*", sessLists[d,1,r])=="TRUE", "rp10s", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<VILLA GONZ[ÁA]LEZ ISA[ÍI]AS\\>.*", sessLists[d,1,r])=="TRUE", "mr04p", sessLists[d,3,r] )
            ...
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<ZEPEDA SEGURA JOS[ÉE]\\>.*", sessLists[d,1,r])=="TRUE", "mr17p", sessLists[d,3,r] )
            sessLists[d,3,r] <- ifelse ( grepl(pattern=".*\\<Z[ÚU]ÑIGA ORTIZ ROC[ÍI]O\\>.*", sessLists[d,1,r])=="TRUE", "mr02s", sessLists[d,3,r] )
            }
...
## Hay que pegarle el vector de nombres antes de eliminar las columnas de diputados que nunca tomarios posesión
